...
'user.register.service.terms':'服务条款',
'user.register.legal.statement':'法律声明',
'user.register.privacy.policy':'隐私政策',
'user.register.and': "和",
'user.register.agree.valid':'请勾选并同意《服务条款》 、《法律声明》、《 隐私政策》',
'user.register.to-login':"立刻前往登录页面",
'user.register.use-agreement':"《OEM App 服务及软件使用许可协议》",
'user.register.agree.valid.use-agreement':'请勾选并同意OEM App开发及软件使用协议',
'user.register.succeed':'注册成功',
